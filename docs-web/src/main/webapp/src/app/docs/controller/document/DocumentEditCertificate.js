...
/**
 * Document edition certificate controller.
 */
angular.module('docs').controller('DocumentEditCertificate', function($rootScope, $scope, $q, $http, $state, $stateParams, Restangular, $translate) {
  // Alerts
  $scope.alerts = [];
